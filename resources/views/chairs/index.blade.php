...
@section('content')
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Chairs</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">All Chairs</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
    ...
    <div class="card mb-6 mb-xl-9">
        <div class="card-body">
            <h1 class="text-dark fw-bolder mt-1 mb-10 fs-3">All Chairs</h1>
