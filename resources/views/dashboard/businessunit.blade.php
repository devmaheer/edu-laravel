...
@section('content')
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center py-2 py-md-1">
            <!--begin::Button-->
            <a href="{{ route('bu.patients.create') }}" class="btn btn-sm btn-dark btn-icon-white fw-bolder me-1">
                Add New Patient
            </a>
            <!--end::Button-->

            <!--begin::Button-->
            <a href="{{ route('bu.appointments.create') }}" class="btn btn-sm btn-dark btn-icon-white fw-bolder">
                Book Appointment
            </a>
            <!--end::Button-->
        </div>
        ...
        let KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $("#today_appointments_datatable").DataTable({
                    ...
                    ajax: {
                        url: "{{ route('bu.appointments.fetch', ['today' => true]) }}",
                    },
                    columns: [
                        { data: 'id' },
                        { data: 'branch.name' },
