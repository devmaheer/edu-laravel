...
@section('content')
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">All Patients</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
    ...
    <div class="card mb-6 mb-xl-9">
        <div class="card-body">
            <h1 class="text-dark fw-bolder mt-1 mb-10 fs-3">All Patients</h1>

            <div class="table-responsive">
                <div class="d-flex flex-stack mb-5">
                    <div class="d-flex align-items-center .position-relative my-1">
                        <input type="text" data-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Patients">
                    </div>
                ...
                <table id="all_patients_datatable" class="table table-rounded table-row-bordered gy-5">
                    <thead>
    ...
    <script>
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                dt = $("#all_patients_datatable").DataTable({
                    searchDelay: 500,
                    scrollY: '525px',
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                return `
                                    <a href="/businessunit/patients/${data.id}/profile" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
