...
@section('content')
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center py-2 py-md-1">
           ...
           <h3 class="mr-5 ms-5"> Question Count: <span>{{count($test->questions)}}</span></h3>
            <!--begin::Button-->
            <button type="button" id="add_mcqs" data-bs-toggle="modal" data-bs-target="#mcqs-modal" class="btn ms-5  btn-dark">
            ...
            <a href="{{ route('admin.test.paragraph.create', ['type' => 'writing', 'id' => $test->id]) }}"
                ...
                <table class="table table-row-dashed table-row-gray-100 align-middle gs-0 gy-3">
                    ...
                    <tbody>
                        @foreach($test->questions as $question)
                           <td>{{$question->name}}</td>
                           <td>{{$question->type == 1 ? 'Writing' : 'Listening'}}</td>
                           <td>
    ...
    @include('admin.question.writing.partials.mcqs-modal')
@endsection
@section('script')
    <script>
