        ...
        <div class="card-body">
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-2">
                    ...
                    <h5 class="mr-5">Paragraph One Qu </h5> <span>{{ $paraCount1 }}</span>

                </div>
           
                <div class="col-md-2">
                    <h5 class="mr-5">Paragraph Two Qu</h5> <span>{{ $paraCount2 }}</span>              

                </div>
                <div class="col-md-2">
                   
                    <h5 class="mr-5">Paragraph Three Qu</h5> <span>{{ $paraCount3 }}</span>              

                </div>
                @if($test->category == '2')
                <div class="col-md-2">
                    <h5 class="mr-5">Paragraph Four Qu</h5> <span>{{ $paraCount4 }}</span>              

                </div>
                <div class="col-md-2">
                    <h5 class="mr-5">Paragraph Five Qu</h5> <span>{{ $paraCount5 }}</span>              
