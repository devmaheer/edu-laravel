    ...
    <div>
        <?php $__currentLoopData = $question->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div>
                ...
                <?php endif; ?>
                <input type="checkbox" onclick="changeColorCode('question_<?php echo e($question->id); ?>','<?php echo e($question->id); ?>')"
                    name="fivechoice[<?php echo e($question->id); ?>][]" value="<?php echo e($option->id); ?>" id="option-<?php echo e($option->id); ?>">
...
<?php /**PATH D:\System\laragon\www\edu-laravel\resources\views/frontend/pages/reading-test/partials/five-choice.blade.php ENDPATH**/ ?>