<?php $__env->startSection('content'); ?>
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center py-2 py-md-1">
            <!--begin::Button-->
            <a href="<?php echo e(route('admin.test.create')); ?>" class="btn btn-sm btn-dark btn-icon-white fw-bolder me-1">
                Add New Test
            </a>
            <!--end::Button-->

            <!--begin::Button-->
            <a href="<?php echo e(route('admin.test.index')); ?>" class="btn btn-sm btn-dark btn-icon-white fw-bolder">
                All Test
            </a>
            <!--end::Button-->
        </div>
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-around">
                                ...
                                <span><?php echo e(count($test)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-around">
                                ...
                                <span><?php echo e($questCount); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-around">
                                ...
                                <span><?php echo e($questionGroupCount); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <?php $__currentLoopData = $test; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($test->type == '1'): ?>
                                                    <span
                                                        class="badge badge-warning"><?php echo e(App\Helper\Helper::getTestType($test->type)); ?></span>
                                                <?php else: ?>
                                                    <span
                                                        class="badge badge-primary"><?php echo e(App\Helper\Helper::getTestType($test->type)); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.question.index', [$test->id])); ?>"
                                                ...
                                                <a href="<?php echo e(route('admin.question.index', [$test->id, 'listening' => 'true'])); ?>"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                ...
                                                <a href="<?php echo e(route('admin.test.edit', [$test->id])); ?>"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\System\laragon\www\edu-laravel\resources\views/admin/index.blade.php ENDPATH**/ ?>