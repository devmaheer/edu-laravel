			...
			<div class="container py-5">
				<div class="row g-5">
					...
					<div class="col-lg-4 col-md-6">
						...
						<a class="btn btn-link" href="<?php echo e(route('frontend.privacy-policy')); ?>">Privacy Policy</a>
						<a class="btn btn-link" href="<?php echo e(route('frontend.faqs')); ?>">FAQs & Help</a>
					</div>
		...
		<!-- Back to Top -->
		<a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a><?php /**PATH D:\System\laragon\www\edu-laravel\resources\views/layouts/partials/frontend-footer.blade.php ENDPATH**/ ?>