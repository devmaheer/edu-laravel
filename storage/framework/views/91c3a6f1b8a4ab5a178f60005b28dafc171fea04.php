    ...
    <!-- Meta Pixel Code -->
    <script>
 <?php if(!Route::is('listening.test') ||!Route::is('reading.test')  ): ?>
  ...
  <?php endif; ?>
  <?php /**PATH D:\System\laragon\www\edu-laravel\resources\views/layouts/partials/frontend-script.blade.php ENDPATH**/ ?>