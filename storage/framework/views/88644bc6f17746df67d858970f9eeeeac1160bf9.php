        ...
        var permissionDatatable = (function () {
            ...
            var initDatatable = function () {
                dt = $("#permissions-table").DataTable({
                    ...
                    ajax: {
                        url: "<?php echo e(route('admin.permissions.fetch')); ?>",
                    },
                    columns: [
                        { data: 'id' },
                        { data: 'name' },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\System\laragon\www\edu-laravel\resources\views/permissions/index.blade.php ENDPATH**/ ?>