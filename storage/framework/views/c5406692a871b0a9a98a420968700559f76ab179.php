...
<?php $__env->startSection('content'); ?>
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center py-2 py-md-1">
            ...
            <a href="<?php echo e(route('admin.question.group.index', ['id' => $test->id, 'type' => 'listening'])); ?>"
                class="btn btn-dark fw-bolder ms-5" id="kt_toolbar_primary_button">Question Group</a>
            <a href="<?php echo e(route('admin.test.audio.create', ['type' => 'listening', 'id' => $test->id])); ?>"
                    ...
                    <tbody>
                        <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo e($question->part); ?>

                                </td>
                                <td>
                                    <?php if($question->category == '2'): ?>
                                        <a href="<?php echo e(route('admin.question.fillinblanks.edit', [$question->id, 'listening' => 'true'])); ?>"
                                        ...
                                        <a href="<?php echo e(route('admin.question.edit', [$question->id, 'listening' => 'true'])); ?>"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <?php elseif($question->category == 3): ?>
                                        <a href="<?php echo e(route('admin.five-options.edit', [$question->id,'listening'=>'true'])); ?>"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                            <span class="svg-icon svg-icon-3">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <?php endif; ?>
                                    <a href="<?php echo e(route('admin.question.delete', [$question->id])); ?>"
    ...
    <?php echo $__env->make('admin.question.listening.partials.mcqs-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.question.listening.partials.filling-blank-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\System\laragon\www\edu-laravel\resources\views/admin/question/listening/index.blade.php ENDPATH**/ ?>