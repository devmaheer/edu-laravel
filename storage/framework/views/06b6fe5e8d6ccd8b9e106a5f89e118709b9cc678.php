        ...
        <div class="hover-scroll-overlay-y my-5 pe-4 me-n4" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-rounded fw-bold fs-6" id="#branches_menu" data-kt-menu="true">
                <div class="menu-item here show">
                    ...
                    <?php else: ?>
                        <a class="menu-link" href="<?php echo e(route('user.dashboard')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('read partner')): ?>
                <div class="menu menu-column menu-rounded fw-bold fs-6" id="#partner_menu" data-kt-menu="true">
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('admin.partners.index')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('read role')): ?>
                <div class="menu menu-column menu-rounded fw-bold fs-6" id="" data-kt-menu="true">
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('admin.roles.index')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('read permission')): ?>
                <div class="menu menu-column menu-rounded fw-bold fs-6" id="" data-kt-menu="true">
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('admin.permissions.index')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="menu menu-column menu-rounded fw-bold fs-6" id="#patients_menu" data-kt-menu="true">
                    <div data-kt-menu-trigger="click" class="menu-item here menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            <div class="menu-item">
                                <a href="<?php echo e(route('admin.test.create')); ?>" class="menu-link">
                            ...
                            <div class="menu-item">
                                <a href="<?php echo e(route('admin.test.index')); ?>" class="menu-link">
                ...
                <div class="menu menu-column menu-rounded fw-bold fs-6" id="#patients_menu" data-kt-menu="true">
                    <div data-kt-menu-trigger="click" class="menu-item here menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            <div class="menu-item">
                                <a href="<?php echo e(route('registeration-request.index')); ?>" class="menu-link">
            ...
            <?php else: ?>
                <div class="menu menu-column menu-rounded fw-bold fs-6" id="#patients_menu" data-kt-menu="true">
                    <div data-kt-menu-trigger="click" class="menu-item here menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <a href="<?php echo e(route('academic.tests')); ?>" class="menu-link">
                                    <span class="menu-title">Academic Tests</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a href="<?php echo e(route('general-training.tests')); ?>" class="menu-link">
...
<!--end::Aside-->
<?php /**PATH D:\System\laragon\www\edu-laravel\resources\views/layouts/partials/aside.blade.php ENDPATH**/ ?>